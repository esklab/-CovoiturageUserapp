...
import 'package:users_app/maiScreen/rate_driver_screen.dart';
import 'package:users_app/maiScreen/search_places_screen.dart';
import 'package:users_app/maiScreen/select_nearest_active_driver_screen.dart';
...
class _MainScreenState extends State<MainScreen>
{
    ...
    if(requestPositionInfo ==true)
      {
        ...
        var directionDetailsInfo= await AssistantMethods.obtainOriginToDestinationDirectionsDetails(
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async
  {
    if(requestPositionInfo ==true)
    {
      ...
      setState(() {
        driverRideStatus = "Le conducteur arrive ::" +directionDetailsInfo.duration_text.toString();
      });
      requestPositionInfo==true;
    }
  }
    ...
    if(response == "driverChosen")
    {
          ...
          .then((snap)
      {
        if(snap.snapshot.value != null)
        {
          ...
          showWaitingResponseUIFromDriverUI();
          //response from a driver
          FirebaseDatabase.instance.ref()
              .child("drivers").child(chosenDriverId!)
              .child("newRideStatus")
              .onValue.listen((eventSnapshot)
          {
            ...
            //2 driver accept the rideRequest Push Notification
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: ()
                        {
                          ...
                          {
                            Fluttertoast.showToast(msg: "Selectionnez un endroit !Merci");
                          }
                        },
                    ...
                    child:AnimatedTextKit(
                      animatedTexts: [
                        FadeAnimatedText(
                          ...
                          textStyle: const TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold, color: Colors.white),
                        ),
                        ScaleAnimatedText(
                          'Attendez',
                          duration: const Duration(seconds: 10),
                          textStyle: const TextStyle(fontSize: 72.0, fontFamily: 'Canterbury',color: Colors.white),
                        ),
                      ],
                    ),
                  ),
